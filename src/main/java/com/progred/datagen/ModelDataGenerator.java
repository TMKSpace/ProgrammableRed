        ...
        for(Block block : INFINIWIRE_BLOCKS.values()){
            blockStateModelGenerator.blockStateCollector.accept(MultipartBlockStateSupplier.create(block)
                    .with(When.anyOf(
                            ...
                            BlockStateVariant.create().put(VariantSettings.MODEL, new Identifier(MODID, "block/redstone_wire/infiniwire_dot"))
                    )
                    .with(When.create().set(Properties.NORTH_WIRE_CONNECTION, WireConnection.SIDE, WireConnection.UP),
                            BlockStateVariant.create().put(VariantSettings.MODEL, new Identifier(MODID, "block/redstone_wire/infiniwire_side0"))
                    )
                    .with(When.create().set(Properties.SOUTH_WIRE_CONNECTION, WireConnection.SIDE, WireConnection.UP),
                            BlockStateVariant.create().put(VariantSettings.MODEL, new Identifier(MODID, "block/redstone_wire/infiniwire_side_alt0"))
                    )
                    .with(When.create().set(Properties.EAST_WIRE_CONNECTION, WireConnection.SIDE, WireConnection.UP),
                            BlockStateVariant.create().put(VariantSettings.MODEL, new Identifier(MODID, "block/redstone_wire/infiniwire_side_alt1")).put(VariantSettings.Y, VariantSettings.Rotation.R270)
                    )
                    .with(When.create().set(Properties.WEST_WIRE_CONNECTION, WireConnection.SIDE, WireConnection.UP),
                            BlockStateVariant.create().put(VariantSettings.MODEL, new Identifier(MODID, "block/redstone_wire/infiniwire_side1")).put(VariantSettings.Y, VariantSettings.Rotation.R270)
                    )
                    .with(When.create().set(Properties.NORTH_WIRE_CONNECTION, WireConnection.UP),
                            BlockStateVariant.create().put(VariantSettings.MODEL, new Identifier(MODID, "block/redstone_wire/infiniwire_up"))
                    )
                    .with(When.create().set(Properties.EAST_WIRE_CONNECTION, WireConnection.UP),
                            BlockStateVariant.create().put(VariantSettings.MODEL, new Identifier(MODID, "block/redstone_wire/infiniwire_up")).put(VariantSettings.Y, VariantSettings.Rotation.R90)
                    )
                    .with(When.create().set(Properties.SOUTH_WIRE_CONNECTION, WireConnection.UP),
                            BlockStateVariant.create().put(VariantSettings.MODEL, new Identifier(MODID, "block/redstone_wire/infiniwire_up")).put(VariantSettings.Y, VariantSettings.Rotation.R180)
                    )
                    .with(When.create().set(Properties.WEST_WIRE_CONNECTION, WireConnection.UP),
                            BlockStateVariant.create().put(VariantSettings.MODEL, new Identifier(MODID, "block/redstone_wire/infiniwire_up")).put(VariantSettings.Y, VariantSettings.Rotation.R270)
                    )
            );
        }
